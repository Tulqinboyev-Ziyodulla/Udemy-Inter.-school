      ...
      <Model isOpen={isUpdate} setIsOpen={setIsUpdate} >
        <form onSubmit={handleUpdate} className='w-full'>
          <label htmlFor="file">
            ...
            <img className='mx-auto rounded-lg cursor-pointer' src={profileImg} alt="img" width={200} height={200} />
          </label>
        <div className="flex w-full justify-between mt-6">
          <div className="w-[48%]  flex flex-col m-auto gap-[20px]">
            <label className="flex flex-col">
              <span className='text-[15px] text-black flex m-auto text-2xl'>First name :</span>
        ...
        <button className=" mt-5 w-48 h-10 text-[22px] flex justify-center m-auto bg-[#1DA1F2] rounded-[30px] text-white" type='submit' >Submit</button>
        </form>
      </Model>
    </div>
  )
